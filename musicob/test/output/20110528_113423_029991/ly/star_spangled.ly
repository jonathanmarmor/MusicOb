...
%			\line { \null }
	...
	oddFooterMarkup = \markup { 
		\on-the-fly #first-page {
			\fill-line {
				...
				\center-column {
					...
					\line { \null }
					\line { \null }
					\line { \override #'(font-name . "Granjon Bold") { "EMSIS no. 12345" } }
				}
				\right-column {
					%\line { \null }
					\line { \null }
		...
		\column {
			...
			\line { \null }
			\line { \null }
			\fill-line { \override #'(font-name . "Granjon Bold") { "EMSIS no. 12345" } }
		}
	}
...
\book {
	\header { 
		maintitle = "The Star Spangled Banner"
		thecomposer = "John Stafford Smith"
		tagline = ""
	}

	\bookpart {
		\header { 
			movementtitle = "The Only Movement" 
			instrumentname = ""
		}
		\score {
			<<
