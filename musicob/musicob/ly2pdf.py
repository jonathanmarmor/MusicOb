...
def ly2pdf(ly_dir_path, pdf_dir_path, piece_filename, score=True, parts=False):
   ...
   if score:
      ...
      run_lilypond(score_path, pdf_dir_path)        
   if parts:
      ...
      for part_filename in parts_filenames:
         ...
         run_lilypond(part_path, pdf_dir_path)
   cleanup(pdf_dir_path)
...
if __name__ == '__main__':
   ...
   ly2pdf(args.ly_dir_path, args.pdf_dir_path, args.piece_filename, score=args.score, parts=args.parts)
