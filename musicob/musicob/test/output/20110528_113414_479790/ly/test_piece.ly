...
#(set-global-staff-size 15) % 20 is default
	...
	\bookpart {
		...
		\score {
			...
			\new Staff {
				...
				\transpose c c
				\include "./score_music/mv1/cl_music.ly"
			}
			\new Staff {
				\numericTimeSignature
				\set Staff.instrumentName = \markup { \override #'(font-name . "Granjon Bold") { "Piano" } }
				\set Staff.shortInstrumentName = \markup { \override #'(font-name . "Granjon Bold") { \hcenter-in #5 "pn" } }
				...
				\override Staff.VerticalAxisGroup #'minimum-Y-extent = #'(-5 . 5.5)  % sets minimum space between staves within a system
				\transpose c c
				\include "./score_music/mv1/pn_music.ly"
			}
			>>
			\layout { }
            \midi { }
	...
	\bookpart {
		...
		\score {
			...
			\new Staff {
				...
				\override Staff.VerticalAxisGroup #'minimum-Y-extent = #'(-5 . 5.5)  % sets minimum space between staves within a system
				\transpose c c
				\include "./score_music/mv2/cl_music.ly"
			}
			\new Staff {
				\numericTimeSignature
				\set Staff.instrumentName = \markup { \override #'(font-name . "Granjon Bold") { "Piano" } }
				...
				\override Staff.VerticalAxisGroup #'minimum-Y-extent = #'(-5 . 5.5)  % sets minimum space between staves within a system
				\transpose c c
				\include "./score_music/mv2/pn_music.ly"
			}
			>>
			\layout { }
            \midi { }
